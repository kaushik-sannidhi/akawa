...
class WeaponDetector:
    def __init__(self, model_path=None):
        ...
        try:
            ...
            fallback = os.path.join(os.path.dirname(os.path.abspath(__file__)), "yolo11m.pt")
    ...
    def _resolve_model_path(self, model_path):
        ...
        return os.path.join(os.path.dirname(os.path.abspath(__file__)), "yolo11m.pt")

    def _get_latest_trained_model(self):
        """Scans the runs/detect directory to find the most recently trained weights."""
        runs_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "runs", "detect")
